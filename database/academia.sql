...
ALTER TABLE `imc`
  ADD PRIMARY KEY (`id`),
  ADD KEY `usuario_id` (`usuario_id`),
  ADD KEY `usuario_data` (`usuario_id`, `criado_em`);
...
--
-- Estrutura para tabelas `eventos` e `humor` (rotina e registro de humor)
--
...
--
-- Estrutura para tabela `avaliacoes_fisicas` (fotos e medidas do avaliador físico)
--
